...
void YabSplitView::position(int oix, int oiy, int newx, int newy) {
...
void YabSplitView::resize(int X,int Y,int W,int H) {
...
static void set_cursor(YabSplitView*t, Fl_Cursor c) {
