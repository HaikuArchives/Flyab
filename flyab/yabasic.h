...
enum functions { /* functions in yabasic (sorted by number of arguments) */
  ...
  fLTRIM,fRTRIM,fTRIM,fCHR,fTRANSLATE,fMOUSE, fISMOUSEIN,fTEXTCONTROLGET,
...
enum cmd_type { /* type of command */
 ...
 /*
  ...
  cLISTBOX, cDROPBOX, cITEMADD, cITEMDEL, cITEMCLEAR, cLOCALIZE, cLOCALIZE2, cTEXT, cTEXT2, cTEXTALIGN,
  ...
  cLISTBOXDEL2, cSCROLLBAR, cSCROLLBARSET1, cSCROLLBARSET2, cTREEBOX7, cTREEBOX8,
  ...
  cSCREENSHOT, cSTATUSBAR, cSTATUSBARSET,
